...
public final class R$styleable {
    ...
    public static final int KeyboardView_keyPreviewHeight = 2;
    public static final int KeyboardView_keyPreviewLayout = 3;
    public static final int KeyboardView_keyPreviewOffset = 4;
    public static final int KeyboardView_keyTextColor = 5;
    public static final int KeyboardView_keyTextSize = 6;
    public static final int KeyboardView_keyboardViewStyle = 7;
    public static final int KeyboardView_labelTextSize = 8;
    ...
    public static final int Keyboard_Key_backgroundType = 0;
    public static final int Keyboard_Key_codes = 1;
    public static final int Keyboard_Key_iconPreview = 2;
    public static final int Keyboard_Key_isActive = 3;
    public static final int Keyboard_Key_isModifier = 4;
    public static final int Keyboard_Key_isRepeatable = 5;
    public static final int Keyboard_Key_isSticky = 6;
    public static final int Keyboard_Key_keyEdgeFlags = 7;
    public static final int Keyboard_Key_keyIcon = 8;
    public static final int Keyboard_Key_keyIconAlign = 9;
    public static final int Keyboard_Key_keyLabel = 10;
    public static final int Keyboard_Key_keyOutputText = 11;
    public static final int Keyboard_Key_keySmallLabel = 12;
    ...
    public static final int Keyboard_Key_stickyState = 16;
    public static final int Keyboard_Row_edgeMargin = 0;
    ...
    public static final int TimepickPrefer_tppdefaultTime = 0;
    public static final int TimepickPrefer_tppmodeTitle = 1;
    ...
    public static final int[] Keyboard_Key = {R.attr.backgroundType, R.attr.codes, R.attr.iconPreview, R.attr.isActive, R.attr.isModifier, R.attr.isRepeatable, R.attr.isSticky, R.attr.keyEdgeFlags, R.attr.keyIcon, R.attr.keyIconAlign, R.attr.keyLabel, R.attr.keyOutputText, R.attr.keySmallLabel, R.attr.keyboardMode, R.attr.popupCharacters, R.attr.popupKeyboard, R.attr.stickyState};
    public static final int[] Keyboard_Row = {R.attr.edgeMargin, R.attr.keyboardMode, R.attr.rowEdgeFlags};
    ...
    public static final int[] TimepickPrefer = {R.attr.tppdefaultTime, R.attr.tppmodeTitle};
